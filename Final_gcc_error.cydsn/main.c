...
const char *SONG0_SEQ[] = 
    {"E5", "D#5", "E5", "D#5", "E5", "B4", "D5", "C5",
     "A4", "C4", "E3", "A3", "B4", "E4", "G#4", "B4",
     "C5", "E5", "D#5", "E5", "D#5", "E5", "B4", "D5", "C5", "A4", "C4", "E4", "A4",
     ...
     "A4", "C4", "E3", "A3", "B4", "E4", "C5", "A4"
    };
const char *SONG1_SEQ[42] = 
...
struct Songs songs[] = {
    { .song_number = 0, .name = "Fur Elise", .note_seq = SONG0_SEQ, .song_length = 84},
