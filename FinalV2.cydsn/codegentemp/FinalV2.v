// ======================================================================
// FinalV2.v generated from TopDesign.cysch
// 05/13/2024 at 16:41
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("884b1584-b86c-42ec-8754-affb34ee9704"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__adc_threshold_net;
	wire [0:0] tmpFB_0__adc_threshold_net;
	wire [0:0] tmpIO_0__adc_threshold_net;
	wire [0:0] tmpINTERRUPT_0__adc_threshold_net;
	electrical [0:0] tmpSIOVREF__adc_threshold_net;

	cy_psoc3_pins_v1_10
		#(.id("08e95177-276a-4b46-b844-9727930fa714"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		adc_threshold
		 (.oe(tmpOE__adc_threshold_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__adc_threshold_net[0:0]}),
		  .io({tmpIO_0__adc_threshold_net[0:0]}),
		  .siovref(tmpSIOVREF__adc_threshold_net),
		  .interrupt({tmpINTERRUPT_0__adc_threshold_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__adc_threshold_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("793be9d2-15af-413c-a305-9fe695a87a28"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d1bc724c-9ebd-4b55-8916-5c0e48900664"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__led_data_net;
	wire [0:0] tmpFB_0__led_data_net;
	wire [0:0] tmpIO_0__led_data_net;
	wire [0:0] tmpINTERRUPT_0__led_data_net;
	electrical [0:0] tmpSIOVREF__led_data_net;

	cy_psoc3_pins_v1_10
		#(.id("429292c1-059e-4703-b79d-414cd7c6a3f9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		led_data
		 (.oe(tmpOE__led_data_net),
		  .y({Net_58}),
		  .fb({tmpFB_0__led_data_net[0:0]}),
		  .io({tmpIO_0__led_data_net[0:0]}),
		  .siovref(tmpSIOVREF__led_data_net),
		  .interrupt({tmpINTERRUPT_0__led_data_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__led_data_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
